	...
	class mainModel{
		...
		protected function guardarDatos($tabla, $datos){
			...
			foreach($datos as $campo){
				$stmt->bindParam($campo['campo_marcador'], $campo['campo_valor']);
			}
		...
		public function actualizarDatos($tabla, $datos, $condicion){
			...
			foreach($datos as $campo){
				$sql .= $campo['campo_nombre']."=".$campo['campo_marcador'].", ";
			}
			...
			// Asociar valores
			foreach($datos as $campo){
				$stmt->bindValue($campo['campo_marcador'], $campo['campo_valor']);
			}
